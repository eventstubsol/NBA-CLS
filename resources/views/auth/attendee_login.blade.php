...
<form id="form" action="{{ route('attendee_login') }}" method="post">
    ...
    <div class="input-group">
        ...
        <input disabled value="{{ old($login["field"]) ?? $email }}" class="form-control @error($login["field"]) is-invalid @enderror"
    ...
    <div class="input-group input-footer">
        <p class="text">Login with Password?<a href="{{ route('login') }}"> Click here</a></p>
