...
<head>
    ...
    <link href="{{ asset("/dflip/css/dflip.css") }}?cb=1611083902567" rel="stylesheet" type="text/css">
    <link href="{{ asset("/dflip/css/themify-icons.css") }}?cb=1611083902567" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="{{ asset('assets/css/app.min.css') }}?cb=1611083902567" type="text/css">
    <link rel="stylesheet" href="{{ asset("event-assets/css/app.css") }}?cb=1611083902567">
...
{{--    @include("event.modules.Faq")--}}
    ...
    <script src="{{ asset('assets/js/vendor.min.js') }}?cb=1611083902567"></script>
    <script src="{{ asset('assets/js/app.min.js') }}?cb=1611083902567"></script>
    <script src="{{ asset("event-assets/js/routie.min.js") }}?cb=1611083902567"></script>
    <script src="{{ asset("event-assets/js/app.js") }}?cb=1611083902567"></script>
    <script src="{{ asset("/js/chat/app.js") }}?cb=1611083902567"></script>
    <!-- <script src="{{ asset("/js/by-laws/App.js") }}?cb=1611083902567"></script> -->
    <script src="{{ asset("/js/profile/index.js") }}?cb=1611083902567"></script>
    <script src="{{asset("event-assets/YouTubePopUp/YouTubePopUp.jquery.js")}}?cb=1611083902567"></script>
    <script src="{{asset("event-assets/YouTubePopUp/PopupInit.js")}}?cb=1611083902567"></script>
