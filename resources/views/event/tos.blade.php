    ...
    <div class="wrapper my-5">
        <div class="page">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1>Privacy Policy for BGICC - Breast- Gynecological &amp; Immunooncology International Cancer
                            Conference</h1>

                        <p>At http://bgicc.net/, accessible from http://congress2021.bgicc.net/, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by http://bgicc.net/ and how we use it.</p>

                        <p>If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us.</p>

                        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in http://bgicc.net/. This policy is not applicable to any information collected offline or via channels other than this website. Our Privacy Policy was created with the help of the <a href="https://www.privacypolicygenerator.info">Privacy Policy Generator</a> and the <a href="https://www.generateprivacypolicy.com/#wizard">Free Privacy Policy Generator</a>.</p>
                        ...
                        <p>http://bgicc.net/ follows a standard procedure of using log files. These files log visitors
                        ...
                        <p>Like any other website, http://bgicc.net/ uses 'cookies'. These cookies are used to store
                        ...
                        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web
                            ...
                            http://bgicc.net/, which are sent directly to users' browser. They automatically receive
                        ...
                        <p>Note that http://bgicc.net/ has no access to or control over these cookies that are used by
                            third-party advertisers.</p>

                        <h2>Third Party Privacy Policies</h2>

                        <p>http://bgicc.net/'s Privacy Policy does not apply to other advertisers or websites. Thus, we
                        ...
                        <p>http://bgicc.net/ does not knowingly collect any Personal Identifiable Information from
