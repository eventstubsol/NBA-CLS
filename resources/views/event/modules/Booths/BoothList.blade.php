...
{{--  Lewis Expo Hall  --}}
 <div class="page booths pb-0" id="room-d4021162-16a5-43a2-aba1-005ac9507717"> 
     <div class="booths position-relative" style="height: 100vh">
        ...
        <div title="Milbank" class= "area candidate-booth positioned" style="width: 8%;  height: 14%;   top: 40%; left: 38%; background-color:red" data-link="booth/e2e001f0-8da1-4bf2-b57a-634d907196dd">
        </div>
         <div title="Mitchell, Williams, Selig, Gates & Woodyard, P.L.L.C." class= "area candidate-booth positioned" style="width: 8%;  height: 14%;   top: 40%;  left: 28%; background-color:red" data-link="booth/68551a82-38f5-46cf-972c-b44c2e478bd7">
        </div>
        <div title="Parker Poe Adams & Bernstein LLP" class= "area candidate-booth positioned" style="width: 8%;  height: 14%;   top: 40%;  left: 17%; background-color:red" data-link="booth/91b2fc2e-d4df-4a1a-a890-00b34ddc9d74">
        </div>
        <div title="Phelps Dunbar, LLP" class= "area candidate-booth positioned" style="width: 8%;  height: 14%;   top: 40%;  left: 6%; background-color:red " data-link="c5fd83da-fd8b-4744-9ceb-8acd9af153e3">
        </div>
