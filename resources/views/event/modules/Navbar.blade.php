    ...
    <div class="container-fluid row">
        <div class="col-5 col-md-2 fluid-col logo-col">
            <div class="logo-box">
                <a class="logo area" data-link="lobby">
                    <img src="{{ assetUrl(getField('logo')) }}" style="max-height: 25px;border-radius: 10px;padding: 0px;">
                </a>
            </div>
        </div>
        <div class="col-2 col-md-8 fluid-col menu-col">
           <ul class="menu">
                ...
                <li><a data-link="infodesk" class="area"><i class="fe-info"></i>Info Desk</a></li>
